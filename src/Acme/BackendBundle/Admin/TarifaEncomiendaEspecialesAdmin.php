...
class TarifaEncomiendaEspecialesAdmin extends Admin{
    
    protected $translationDomain = 'messages';
    protected $baseRouteName = 'sonata_tarifa_encomienda_especiales_admin';
    protected $baseRoutePattern = 'tarifaencomiendaespeciales';
