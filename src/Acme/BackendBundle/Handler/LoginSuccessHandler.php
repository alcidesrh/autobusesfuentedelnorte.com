...
class LoginSuccessHandler implements AuthenticationSuccessHandlerInterface{
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token)
    {
        ...
        $this->container->get("logger")->notice('Autenticado satisfactoriamente el usuario:'. $token->getUser() . ".", $context);
        $session = $this->container->get('request')->getSession();
        $session->set("username", $token->getUser()->getUsername()); //Para los log fails
...
//	}
//	return $response;
        return new RedirectResponse($this->container->get("router")->generate('home-default'));
    }
}
