...
class VencerReservacionesCommand extends ContainerAwareCommand{
            
    protected function configure()
    {
        $this
            ->setName('SISTEMA:vencer:reservaciones')
            ->setHelp("Vencer Reservaciones")
        ;
    }
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            if($job = $em->getRepository('AcmeBackendBundle:Job')->findOneBy(['serviceId' => 'acme_backend_reservacion', 'status' => Job::STATUS_WAITING])){
