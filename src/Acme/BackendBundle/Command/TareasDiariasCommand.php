...
class TareasDiariasCommand extends ContainerAwareCommand{
            
    protected function configure()
    {
        $this
            ->setName('SISTEMA:tareas:diarias')
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            if($job = $em->getRepository('AcmeBackendBundle:Job')->findOneBy(['serviceId' => 'acme_backend_tareas_diarias', 'status' => Job::STATUS_WAITING])){
