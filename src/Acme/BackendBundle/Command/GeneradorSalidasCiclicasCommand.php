...
class GeneradorSalidasCiclicasCommand extends ContainerAwareCommand{
            
    protected function configure()
    {
        $this
            ->setName('SISTEMA:salida:ciclicas')
            ->setHelp("Generador de Salidas Ciclicas")
        ;
    }
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            if($job = $em->getRepository('AcmeBackendBundle:Job')->findOneBy(['serviceId' => 'acme_backend_salida', 'status' => Job::STATUS_WAITING])){
