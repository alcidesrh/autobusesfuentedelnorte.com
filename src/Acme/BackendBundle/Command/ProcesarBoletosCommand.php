...
class ProcesarBoletosCommand extends ContainerAwareCommand{
            
    protected function configure()
    {
        $this
            ->setName('SISTEMA:procesar:boletos')
            ->setHelp("Procesar Boletos")
        ;
    }
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            if($job = $em->getRepository('AcmeBackendBundle:Job')->findOneBy(['serviceId' => 'acme_backend_procesar_boletos', 'status' => Job::STATUS_WAITING])){
