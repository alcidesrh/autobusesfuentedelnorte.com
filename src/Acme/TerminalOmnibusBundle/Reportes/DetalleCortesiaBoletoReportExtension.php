...
class DetalleCortesiaBoletoReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "detalleCortesiaBoleto";
    public $alias = "detalleCortesiaBoleto";
    public $enabled = true;
    public function getParam(){
        ...
        if($this->container !== null){
            ...
            $command = $request->get('detalleCortesiaBoleto');
