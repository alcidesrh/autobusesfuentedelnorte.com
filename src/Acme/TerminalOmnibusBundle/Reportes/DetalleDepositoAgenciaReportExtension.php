...
class DetalleDepositoAgenciaReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "detalleDepositoAgencia";
    public $alias = "detalleDepositoAgencia";
    public $enabled = true;
    public function getParam(){
        ...
        if($this->container !== null){
            ...
            $command = $request->get('detalleDepositoAgencia');
