...
class VentaBoletoOtrasEstacionesReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "ventaBoletoOtrasEstaciones";
    public $alias = "ventaBoletoOtrasEstaciones";
    public $enabled = true;
    public function getParam(){
        ...
        if($this->container !== null){
            ...
            if($moneda !== null && trim($moneda) !== ""){
                $parameters->put('MONEDA_ID', intval($moneda));
            }
            $usuario = $command["usuario"];
            if($usuario !== null && trim($usuario) !== ""){
                $parameters->put('USUARIO_DATA_ID', intval($usuario));
            }
