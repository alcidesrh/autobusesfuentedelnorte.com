...
class DetalleAgenciaGraficoReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "detalleAgenciaGrafico";
    public $alias = "detalleAgenciaGrafico";
    public $enabled = true;
    public function getParam(){
        ...
        if($this->container !== null){
            ...
            $command = $request->get('detalleAgenciaGrafico');
