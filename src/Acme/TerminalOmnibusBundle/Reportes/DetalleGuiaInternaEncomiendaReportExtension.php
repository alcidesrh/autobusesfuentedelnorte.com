...
class DetalleGuiaInternaEncomiendaReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "detalleGuiaInternaEncomienda";
    public $alias = "detalleGuiaInternaEncomienda";
    public $enabled = true;
    public function getParam(){
        ...
        if($this->container !== null){
            ...
            $command = $request->get('detalleGuiaInternaEncomienda');
