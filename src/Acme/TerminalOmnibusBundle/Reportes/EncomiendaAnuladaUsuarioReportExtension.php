...
class EncomiendaAnuladaUsuarioReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "encomiendaAnuladaUsuario";
    public $alias = "encomiendaAnuladaUsuario";
    public $enabled = true;
    public function getParam(){
        ...
        if($this->container !== null){
            ...
            $command = $request->get('encomiendaAnuladoUsuario');
            ...
            if($usuario !== null && trim($usuario) !== ""){
                $parameters->put('USUARIO_DATA_ID', $usuario);
            }
