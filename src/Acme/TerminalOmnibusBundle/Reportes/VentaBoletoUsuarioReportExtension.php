...
class VentaBoletoUsuarioReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "ventaBoletoUsuario";
    public $alias = "ventaBoletoUsuario";
    public $enabled = true;
