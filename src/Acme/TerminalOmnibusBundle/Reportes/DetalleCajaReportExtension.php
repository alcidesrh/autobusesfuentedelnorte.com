...
class DetalleCajaReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "detalleCaja";
    public $alias = "detalleCaja";
    public $enabled = true;
    public function getParam(){
        ...
        if($this->container !== null){
            ...
            $command = $request->get('detalleCaja');
            ...
            if($usuario !== null && trim($usuario) !== ""){
                $parameters->put('DATA_USUARIO_ID', intval(trim($usuario)));
            }
