...
class DetalleFacturaEncomiendaReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "detalleFacturaEncomienda";
    public $alias = "detalleFacturaEncomienda";
    public $enabled = true;
