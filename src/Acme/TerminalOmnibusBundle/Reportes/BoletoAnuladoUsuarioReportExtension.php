...
class BoletoAnuladoUsuarioReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "boletoAnuladoUsuario";
    public $alias = "boletoAnuladoUsuario";
    public $enabled = true;
