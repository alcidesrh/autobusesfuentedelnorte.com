...
class EncomiendaPropietarioReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "encomiendaPropietario";
    public $alias = "encomiendaPropietario";
    public $enabled = true;
    public function getParam(){
        ...
        if($this->container !== null){
            ...
            $command = $request->get('encomiendaPropietario');
