...
class ManisfiestoBoletoEspecialReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "manisfiestoBoletoEspecial";
    public $alias = "manisfiestoBoletoEspecial";
    public $enabled = true;
    public function getParam(){
        ...
        if($this->container !== null){
            ...
            $command = $request->get('manisfiestoBoletoEspecial');
            if($command === null){
