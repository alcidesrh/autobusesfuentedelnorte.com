...
class DetalleCortesiaEncomiendaReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "detalleCortesiaEncomienda";
    public $alias = "detalleCortesiaEncomienda";
    public $enabled = true;
    public function getParam(){
        ...
        if($this->container !== null){
            ...
            $command = $request->get('detalleCortesiaEncomienda');
