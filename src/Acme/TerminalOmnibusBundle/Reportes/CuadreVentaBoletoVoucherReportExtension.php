...
class CuadreVentaBoletoVoucherReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "cuadreVentaBoletoVoucher";
    public $alias = "cuadreVentaBoletoVoucher";
    public $enabled = true;
    public function getParam(){
        ...
        if($this->container !== null){
            ...
            $command = $request->get('cuadreVentaBoletoVoucher');
