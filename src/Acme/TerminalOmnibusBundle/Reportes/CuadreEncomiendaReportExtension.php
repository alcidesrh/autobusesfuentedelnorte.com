...
class CuadreEncomiendaReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "cuadreEncomienda";
    public $alias = "cuadreEncomienda";
    public $enabled = true;
    public function getParam(){
        ...
        if($this->container !== null){
            ...
            $command = $request->get('cuadreEncomienda');
