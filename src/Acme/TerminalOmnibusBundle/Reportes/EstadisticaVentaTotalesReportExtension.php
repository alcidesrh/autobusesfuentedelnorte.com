...
class EstadisticaVentaTotalesReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "estadisticaVentaTotales";
    public $alias = "estadisticaVentaTotales";
    public $enabled = true;
    public function getParam(){
        ...
        if($this->container !== null){
            ...
            $command = $request->get('estadisticaVentaTotales');
