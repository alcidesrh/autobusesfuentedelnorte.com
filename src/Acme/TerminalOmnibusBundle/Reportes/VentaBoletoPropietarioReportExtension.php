...
class VentaBoletoPropietarioReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "ventaBoletoPropietario";
    public $alias = "ventaBoletoPropietario";
    public $enabled = true;
