...
class VentaBoletoPrepagadoReportExtension extends \ReportExtension{
    
    public $container = null;
    public $reportFileName = "ventaBoletoPrepagado";
    public $alias = "ventaBoletoPrepagado";
    public $enabled = true;
