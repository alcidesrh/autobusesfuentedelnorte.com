...
class CancelarCajaType extends AbstractType{
    ...
    {  
       ...
       $totalOperaciones = $this->doctrine->getManager()->getRepository('AcmeTerminalOmnibusBundle:OperacionCaja')->obtenerTotalOperaciones($caja);
               
       $builder->add('totalOperaciones', 'text',  array(
            'label' => 'Total de Operaciones', 
            'read_only' => true,
            'virtual' => true,
            'required' => true,
            'data' => abs($totalOperaciones),
            'attr' =>  array('class' => 'span9'),
        ));
    }
