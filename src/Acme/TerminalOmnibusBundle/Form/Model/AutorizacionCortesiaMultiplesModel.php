...
class AutorizacionCortesiaMultiplesModel {
    ...
    */
    ...
    public function getUsuarioNotificacion() {
        return $this->usuarioNotificacion;
    }

    public function setUsuarioNotificacion($usuarioNotificacion) {
