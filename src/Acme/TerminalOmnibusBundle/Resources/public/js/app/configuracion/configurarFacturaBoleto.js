configurarFacturaBoleto = {
    ...
    _conectEvents : function() {
        $("#configurar_factura_command_empresa").on("change", configurarFacturaBoleto.loadFacturas);
        ...
        $("#aceptar").click(configurarFacturaBoleto.clickAceptar);
    },
