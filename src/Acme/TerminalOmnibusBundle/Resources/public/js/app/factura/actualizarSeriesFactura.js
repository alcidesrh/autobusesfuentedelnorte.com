actualizarSeriesFactura = {
    
    funcionesAddOnload : function() {
//        console.debug("actualizarSeriesFactura.funcionesAddOnload-init");
	this._init();		
	this._conectEvents();
//	console.debug("actualizarSeriesFactura.funcionesAddOnload-end");
    },
    ...
    _conectEvents : function() {
        ...
        $("#aceptar").click(actualizarSeriesFactura.clickAceptar);
    },
