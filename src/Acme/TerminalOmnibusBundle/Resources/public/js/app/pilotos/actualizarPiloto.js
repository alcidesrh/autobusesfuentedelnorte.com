actualizarPiloto = {
    ...
    _init : function() {
        ...
        $("#actualizar_piloto_command_empresa").select2({
            allowClear: true
        });
        $("#actualizar_piloto_command_nacionalidad").select2({
            allowClear: false
        });
        $("#actualizar_piloto_command_sexo").select2({
            allowClear: false
        });
        $('#actualizar_piloto_command_fechaNacimiento').datepicker({
            format: "dd/mm/yyyy",
            startDate: "-100y",
            endDate: "d",
            todayBtn: true,
        ...
        $('#actualizar_piloto_command_fechaVencimientoLicencia').datepicker({
            format: "dd/mm/yyyy",
            startDate: "-20y",
            endDate: "+20y",
            todayBtn: true,
    ...
    _conectEvents : function() {
        ...
        $("#aceptar").click(actualizarPiloto.clickAceptar);
    },
