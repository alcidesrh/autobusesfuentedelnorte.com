...
//    protected $restriccionRuta;   
    ...
    * @ORM\JoinColumn(name="restriccion_salida_id", referencedColumnName="id", nullable=true)   
    */
    ...
    */
    ...
    /**
    * @ORM\OneToOne(targetEntity="Boleto", mappedBy="autorizacionCortesia", cascade={"persist"})
    */
    protected $boleto;
    /******************     RESTRICCIONES - INIT    **************************************/
