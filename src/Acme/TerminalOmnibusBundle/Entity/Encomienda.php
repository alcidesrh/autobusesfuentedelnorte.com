...
class Encomienda
{
     ...
     * @ORM\JoinColumn(name="ultima_bitacora_id", referencedColumnName="id", nullable=true, onDelete="SET NULL")   
     */
    protected $bitacora;

    /**
     * @ORM\ManyToOne(targetEntity="Salida")
     * @ORM\JoinColumn(name="primera_salida_id", referencedColumnName="id", nullable=true, onDelete="SET NULL")   
     */
    ...
    public function validacionesGenerales(ExecutionContext $context)
    {
        ...
        if ($this->tipoEncomienda !== null && $this->tipoEncomienda->getId() === TipoEncomienda::EFECTIVO) {
            ...
            if ($this->tipoEncomiendaEspecial === null) {
                ...
                if (
                    $this->tipoDocumento->getId() === TipoDocumentoEncomienda::AUTORIZACION_CORTESIA &&
                    ...
                    $this->tipoDocumento->getId() === TipoDocumentoEncomienda::AUTORIZACION_INTERNA &&
                    ...
                    $this->tipoDocumento->getId() === TipoDocumentoEncomienda::FACTURA &&
                    ...
                    $this->tipoDocumento->getId() === TipoDocumentoEncomienda::POR_COBRAR &&
