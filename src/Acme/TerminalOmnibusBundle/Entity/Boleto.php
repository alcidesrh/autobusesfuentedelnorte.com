...
class Boleto {
    ...
    * @ORM\JoinColumn(name="reasignado_id", referencedColumnName="id")
    */
...
//    protected $codigoBarra;
    ...
    * @ORM\JoinColumn(name="factura_generada_id", referencedColumnName="id", nullable=true, unique=true)   
    */
    protected $facturaGenerada;
    
    /**
    * @ORM\OneToOne(targetEntity="VoucherAgencia", inversedBy="boleto", cascade={"persist"})
    * @ORM\JoinColumn(name="voucher_agencia_id", referencedColumnName="id", nullable=true, unique=true)
    */
    protected $voucherAgencia;
    
    /**
    * @ORM\OneToOne(targetEntity="VoucherEstacion", inversedBy="boleto", cascade={"persist"})
    * @ORM\JoinColumn(name="voucher_estacion_id", referencedColumnName="id", nullable=true, unique=true)
    */
    protected $voucherEstacion;
    
    /**
    * @ORM\OneToOne(targetEntity="VoucherInternet", inversedBy="boleto", cascade={"persist"})
    * @ORM\JoinColumn(name="voucher_internet_id", referencedColumnName="id", nullable=true, unique=true)
    */
    protected $voucherInternet;
    
    /**
    * @ORM\OneToOne(targetEntity="AutorizacionCortesia", inversedBy="boleto", cascade={"persist"})
    ...
    */
    public function validacionesGenerales(ExecutionContext $context, $container)
    {
        ...
        if($this->tipoDocumento->getId() === TipoDocumentoBoleto::AUTORIZACION_CORTESIA){
            ...
            if($this->tipoPago !== null){
                if($this->tipoPago->getId() === TipoPago::TARJETA_CREDITO || $this->tipoPago->getId() === TipoPago::TARJETA_DEBITO
